    ...
    <section>
        <div class="Study_Material">
            ...
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-1 Results</legend>
                <?php
    $path    = '../../Results/MCA Sem-1/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MCA Sem-1/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-2 Results</legend>
                <?php
    $path    = '../../Results/MCA Sem-2/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MCA Sem-2/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-3 Results</legend>
                <?php
    $path    = '../../Results/MCA Sem-3/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MCA Sem-3/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-4 Results</legend>
                <?php
    $path    = '../../Results/MCA Sem-4/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MCA Sem-4/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
?>
    ...
    <!--MBA Results-->
        <div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-1 Results</legend>
                <?php
    $path    = '../../Results/MBA Sem-1/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MBA Sem-1/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-2 Results</legend>
                <?php
    $path    = '../../Results/MBA Sem-2/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MBA Sem-2/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-3 Results</legend>
                <?php
    $path    = '../../Results/MBA Sem-3/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MBA Sem-3/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-4 Results</legend>
                <?php
    $path    = '../../Results/MBA Sem-4/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Results/MBA Sem-4/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
