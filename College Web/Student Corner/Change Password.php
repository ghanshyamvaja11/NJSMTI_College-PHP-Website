...
if (empty($_SESSION['Login_type']) || $_SESSION['Login_type'] != 'Student') {        
...
if(isset($_POST['Reset']))
{
   ...
   if($_SESSION['Login_type'] == "Student")
   {
    ...
    if($_SESSION['Login_type'] == 'Student' && $New_Password == $Confirm_Password && $Count != 1){
        $sql = "UPDATE `Student Registration` SET Password='md5($Confirm_Password)' WHERE Enrollment_No=$Username";
