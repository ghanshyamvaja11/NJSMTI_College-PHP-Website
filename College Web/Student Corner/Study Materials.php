...
<div class="icon" onclick="toggleMenu()">
    ...
    <a href="Study Materials.php" style="color: white; background-color: red; font-weight: bolder; border: 2px solid white; border-radius: 29.9px;">Study-Material</a>
    ...
    <section>
        <div class="Study_Material">
            ...
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-1 Study Material</legend>
                <?php
    $path    = '../../Study Material/MCA Sem-1/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MCA Sem-1/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-2 Study Material</legend>
                <?php
    $path    = '../../Study Material/MCA Sem-2/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MCA Sem-2/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-3 Study Material</legend>
                <?php
    $path    = '../../Study Material/MCA Sem-3/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MCA Sem-3/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-4 Study Material</legend>
                <?php
    $path    = '../../Study Material/MCA Sem-4/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MCA Sem-4/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            while($check = $result -> fetch_assoc()){
                if($check['Course']  == "MCA" && $check['Semester'] == "Sem-6"){
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MCA Sem-6 Study Material</legend>
                <?php
    $path    = '../../Study Material/MCA Sem-6/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MCA Sem-6/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
?>
    ...
    <!--MBA Study Material-->
        <div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-1 Study Material</legend>
                <?php
    $path    = '../../Study Material/MBA Sem-1/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MBA Sem-1/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-2 Study Material</legend>
                <?php
    $path    = '../../Study Material/MBA Sem-2/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MBA Sem-2/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-3 Study Material</legend>
                <?php
    $path    = '../../Study Material/MBA Sem-3/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MBA Sem-3/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
...
<div class="Study_Material">
            ...
            ?>
            <fieldset style="width: 87%;">
                <legend style="background-color: red;">MBA Sem-4 Study Material</legend>
                <?php
    $path    = '../../Study Material/MBA Sem-4/';
$files = scandir($path);
$files = array_diff(scandir($path), array('.', '..'));
foreach($files as $file){ ?>
<a href="../../Study Material/MBA Sem-4/<?php echo $file?>" download><?php echo $file; ?></a><br>
<?php
}
}
}
