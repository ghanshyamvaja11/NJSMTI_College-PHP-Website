...
if (empty($_SESSION['Username'] && $_SESSION['Password']) || $_SESSION['Login_type'] != 'Clerk') {        
...
if(isset($_POST['Reset']))
{
    ...
    //Clerk
    $sql = "SELECT Email FROM `Login` WHERE Login_type='Clerk'";
   ...
   if($_SESSION['Login_type'] == "Clerk")
   {
    ...
    //Clerk new Email
    if($_SESSION['Login_type'] == 'Clerk' && $Count != 1){
        $sql = "UPDATE `Login` SET Email='$Email' WHERE Login_Type='Clerk'";
