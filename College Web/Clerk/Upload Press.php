...
<div class="navbar">
    ...
    <a href="Post new Press Release Posteds.php">Do Press Release Posteds</a>
    ...
    <a href="Upload Press"  style="color: white; background-color: red; font-weight: bolder; border: 2px solid white; border-radius: 29.9px;">Upload Press</a>
</div>
</section>

<main>
    <hr>
        <center><h2 style='color: white; background-color: red; border-radius: 29px; padding-bottom: 4.2px;'>Post  new Press Release Posteds</h2></center>
    <center>
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <hr>
        <!--Send files in Press Folder using PHP-->
        <?php
        if(isset($_POST['upload'])){
           ...
           while($Match = $results -> fetch_assoc()){
               $to = $Match['Email'];
               $Subject = "NJSMTI - New Press Release Posted";
