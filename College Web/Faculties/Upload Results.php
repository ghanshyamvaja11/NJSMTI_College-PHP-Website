...
<main>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <select name="path" id="path" style='height: 29px;'>
            ...
            <option value='../../Results/MCA Sem-4/'>/Results/MCA Sem-4/</option>
 ...
 <option value='../../Results/MBA Sem-4/'>/Results/MBA Sem-4/</option>
        ...
        if(isset($_POST['upload'])){
            ...
            //MCA Results
            if($_POST['path'] == '../../Results/MCA Sem-1/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MCA Sem-1/'.$fileName)){
...
else if($_POST['path'] == '../../Results/MCA Sem-2/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MCA Sem-2/'.$fileName)){
            echo "<center><h4 style='color: white; background-color: green;'>file Uploaded Successfully.</h4></center>";
                }
                else{
            echo "<center><h4 style='color: white; background-color: red;'>select atleast one file to upload on server..</h4></center>";
...
else if($_POST['path'] == '../../Results/MCA Sem-3/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MCA Sem-3/'.$fileName)){
            echo "<center><h4 style='color: white; background-color: green;'>file Uploaded Successfully.</h4></center>";
                }
                else{
            echo "<center><h4 style='color: white; background-color: red;'>select atleast one file to upload on server..</h4></center>";
...
else if($_POST['path'] == '../../Results/MCA Sem-4/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MCA Sem-4/'.$fileName)){
            echo "<center><h4 style='color: white; background-color: green;'>file Uploaded Successfully.</h4></center>";
                }
                else{
            echo "<center><h4 style='color: white; background-color: red;'>select atleast one file to upload on server..</h4></center>";
        ...
        //MBA Results
        if($_POST['path'] == '../../Results/MBA Sem-1/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MBA Sem-1/'.$fileName)){
            echo "<center><h4 style='color: white; background-color: green;'>file Uploaded Successfully.</h4></center>";
                }
                else{
            echo "<center><h4 style='color: white; background-color: red;'>select atleast one file to upload on server..</h4></center>";
            ...
            else if($_POST['path'] == '../../Results/MBA Sem-2/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MBA Sem-2/'.$fileName)){
            echo "<center><h4 style='color: white; background-color: green;'>file Uploaded Successfully.</h4></center>";
                }
                else{
            echo "<center><h4 style='color: white; background-color: red;'>select atleast one file to upload on server..</h4></center>";
            ...
            if($_POST['path'] == '../../Results/MBA Sem-3/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MBA Sem-3/'.$fileName)){
            echo "<center><h4 style='color: white; background-color: green;'>file Uploaded Successfully.</h4></center>";
                }
                else{
            echo "<center><h4 style='color: white; background-color: red;'>select atleast one file to upload on server..</h4></center>";
            ...
            if($_POST['path'] == '../../Results/MBA Sem-4/'){
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Results/MBA Sem-4/'.$fileName)){
            echo "<center><h4 style='color: white; background-color: green;'>file Uploaded Successfully.</h4></center>";
                }
                else{
            echo "<center><h4 style='color: white; background-color: red;'>select atleast one file to upload on server..</h4></center>";
