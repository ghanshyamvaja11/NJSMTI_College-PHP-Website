...
if (empty($_SESSION['Username'] && $_SESSION['Password']) || ($_SESSION['Username'] != ('Librarian@kmkks' || 'Principal@kmkks'))) {        
...
<form method="POST">
 <br><input type='Submit' name='Logout' Value='Logout' id='Logout'> </form>
</div>
</section>

<main>
      <center><h1 style='color: white; background-color: green; border-radius: 29px; padding-bottom: 4.2px;'>Librarian Desk</h1></center>
