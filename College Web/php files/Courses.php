...
<div class="icon" onclick="toggleMenu()">
    ...
    <a href="Courses.php" style="color: yellow; background-color: black; font-weight: bolder; border: 2px solid white; border-radius: 29px;">Courses</a>
...
<main>
    <section>
        ...
        <center>
            <h4>Choose anyone:</h4>
            <p>
    <a href="../Courses/MCA.php"><input type="button" value="MCA"></a>
    <p>
    <a href="../Courses/MBA.php"><input type="button" value="MBA"></a>
        </center>
        </div>
    </section>
</main>
