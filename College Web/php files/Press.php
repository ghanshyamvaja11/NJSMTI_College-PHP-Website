...
<div class="icon" onclick="toggleMenu()">
    ...
    <a href="Press.php"   style="color: yellow; background-color: black; font-weight: bolder; border: 2px solid white; border-radius: 29px;">Press</a>
...
<img src="../../Press/<?php echo $file?>" alt="Press" class="imgs" style="border: 2px solid black;">
<?php
}
?>
        </center>
