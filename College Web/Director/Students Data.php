...
<main>
    ...
    <form action="" method="POST">
        <input type="number" id="SPU_ID" name="Enrollment_No" placeholder="Enter Student's Enrollment No" style='height: 29px;'><p>
    ...
    $Count = 1;
     ...
     if($Count == 0){
         echo "<h4 style='color: red'>EnrollmentNo : <span style='color: green;'>$EnrollmentNo</span> not found in Our database. Enter Valid EnrollmentNo.</h4>";
     }
     }
?>
</form>
