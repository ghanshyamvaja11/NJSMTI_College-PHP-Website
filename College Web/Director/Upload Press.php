...
</form><center><h1 style='color: white; background-color: green; border-radius: 29px; padding-bottom: 4.2px;'>Clerk Desk</h1></center>
<div class="navbar">
    ...
    <a href="Upload Press.php" style="color: white; background-color: red; font-weight: bolder; border: 2px solid white; border-radius: 29.9px;">Upload Press</a>
</div>
</section>

<main>
    <hr>
        <center><h2 style='color: white; background-color: red; border-radius: 29px; padding-bottom: 4.2px;'>Post  new Press Releases</h2></center>
    <center>
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <select name="path" id="path" style='height: 29px;'>
            <option value="../../Images/Press/">/Press/</option>
        </select><p>
        ...
        <hr>
        <!--Send files in Press Release Folder using PHP-->
        <?php
        if(isset($_POST['upload'])){
             $fileName = $_FILES['file']['name'];
                if(move_uploaded_file($_FILES['file']['tmp_name'], '../../Press/'.$fileName)){
           ...
           while($Match = $results -> fetch_assoc()){
               $to = $Match['Email'];
               $Subject = "NJSMTI - New Press Release";
               $Message = "New Press Release Posted\n\n Username  : " . $Match['Enrollment_No'] . "\n"."Password :" . $Match['Password'] . "\n" . "Click on This Link To Login : https://njsmti.000webhostapp.com/College%20Web/Login/Login.php";
